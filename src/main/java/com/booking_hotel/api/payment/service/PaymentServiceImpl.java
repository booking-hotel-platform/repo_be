    ...
    public StripeResponse checkoutBooking(Long bookingId, String token) {
        ...
        SessionCreateParams params =
                SessionCreateParams.builder()
                        ...
                        .setSuccessUrl("https://jame-booking.netlify.app/checkout/success?bookingId=" + bookingId)
                        .setCancelUrl("https://jame-booking.netlify.app/checkout/cancel?bookingId=" + bookingId)
